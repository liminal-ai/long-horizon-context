...
/**
 * Panel hint for the confirmation. Plain ASCII, like every row we draw, and
 * the panel's own command spelling: this screen is Control Panel surface.
 */
export const COMPACT_CONFIRM_HINT = "y = run /smart-compact now and kill this work  |  any other key = not now";
