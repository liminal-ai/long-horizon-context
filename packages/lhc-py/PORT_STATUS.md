...
|---|---|---|---|---|
| 1 | `src/index.ts` | `src/lhc/__init__.py` | ☐ |  |
...
| 6 | `src/intake-stream/index.ts` | `src/lhc/intake_stream/__init__.py` | ☐ |  |
...
| 9 | `src/messages/index.ts` | `src/lhc/messages/__init__.py` | ☐ |  |
...
| 23 | `src/shared-tech/derivation.ts` | `src/lhc/shared_tech/derivation.py` | ◐ | PARTIAL (exemplar type subset; Wave 1 completes) |
| 24 | `src/shared-tech/deterministic.ts` | `src/lhc/shared_tech/deterministic.py` | ☑ | exemplar |
| 25 | `src/shared-tech/durable-work/index.ts` | `src/lhc/shared_tech/durable_work/__init__.py` | ☐ |  |
...
| 28 | `src/shared-tech/inference-adapter.ts` | `src/lhc/shared_tech/inference_adapter.py` | ☐ |  |
...
| 51 | `src/shared-tech/work-queue/index.ts` | `src/lhc/shared_tech/work_queue/__init__.py` | ☐ |  |
...
| 63 | `src/threads/index.ts` | `src/lhc/threads/__init__.py` | ☐ |  |
| 64 | `src/threads/internal/create.ts` | `src/lhc/threads/internal/create.py` | ☐ |  |
| 65 | `src/threads/internal/registry.ts` | `src/lhc/threads/internal/registry.py` | ☐ |  |
| 66 | `src/turns/index.ts` | `src/lhc/turns/__init__.py` | ☐ |  |
...
| `test/fixtures/inference-callbacks-double.ts` | `tests/fixtures/inference_callbacks_double.py` | ☐ |  |
| `test/fixtures/intake-seam.ts` | `tests/fixtures/intake_seam.py` | ☐ |  |
| `test/fixtures/lifecycle.ts` | `tests/fixtures/lifecycle.py` | ☐ |  |
| `test/fixtures/model-call.ts` | `tests/fixtures/model_call.py` | ☐ |  |
...
| `test/fixtures/threads.ts` | `tests/fixtures/threads.py` | ☐ |  |
...
| `test/fixtures/work-handlers.ts` | `tests/fixtures/work_handlers.py` | ☐ |  |
