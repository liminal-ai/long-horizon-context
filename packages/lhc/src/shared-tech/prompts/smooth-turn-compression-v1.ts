  ...
  render: (i) => [
    {
      ...
      content: [
        ...
        "",
        "Two-pass self-check: If it is too short, expand it by restoring missing substance. If it is too long, contract it by removing lower-value detail and repeated explanation.",
