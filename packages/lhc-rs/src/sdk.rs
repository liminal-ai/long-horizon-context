...
pub use crate::compact_continuation::{
    ...
    CompactContinuationRunResult, CompactContinuationWriterOwnershipCheck, ForceIntentRow,
    StageName, StoredCompactContinuationReceipt, StoredOperationIdentity, ToolPairProof,
    WriterClaimRow, WriterOwnershipQuery, compute_attempt_intent, compute_operation_identity,
