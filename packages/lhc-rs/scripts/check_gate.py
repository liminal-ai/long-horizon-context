...
Rust-adapted):
  ...
  passed     transitional mode (real Phase-2 todos remain): exact-name
             ...
             864 passed / 0 notimpl / 15 ignored / 0 wrong / 0 suspicious.
    ...
    if final_mode:
        ...
        if (
            ...
            print(
                ...
                "passed=864 notimpl=0 ignored=15 wrong=0 suspicious=0"
            )
            return 1
    print("GATE PASS")
    return 0
