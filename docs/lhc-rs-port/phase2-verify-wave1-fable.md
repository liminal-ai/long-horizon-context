# Phase 2 Wave 1 verification — Fable

You are the independent Fable 5 verifier for Wave 1 of 7 in Phase 2 of the
`lhc-rs` port (unit 9 of approximately 18 across the full three-phase
