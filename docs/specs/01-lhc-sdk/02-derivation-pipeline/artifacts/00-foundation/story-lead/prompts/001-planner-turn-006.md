...
latestArtifacts:
  ...
  -
    kind: "ruling-response"
    path: "/Users/leemoore/code/pi-long-horizon/liminal-context/packages/lhc/docs/02-specs/02-derivation-pipeline/artifacts/00-foundation/story-lead/001-ruling-response-002.json"
    provenance: "caller-input"
...
[]
  rulings:
    ...
    -
      ...
      decision: "approve"
      rationale: "All five recorded deviations reviewed and approved: (1) idx_work_item_queue without rowid is a SQLite syntax constraint with identical head-selection semantics enforced at query time; (2) versioned-id amendment is the pre-sanctioned test-plan amendment, executed with red-manifest regeneration; (3) schema-version 4→5 assertions already ratified under ruling-012; (4) poke seam in shared/context.ts preserves DD-5 transactional semantics while avoiding an import cycle; (5) DD-11 CLI provider resolution defers to Story 1 where the first provider-backed CLI command (work drain) lands — no Story 0 surface needs it. None alter epic contracts."
      source: "impl-lead"
nextIntent:
  actionType: "apply-ruling"
  summary: "00-foundation-story-run-001-ruling-spec-deviation: approve"
  artifactRef: "/Users/leemoore/code/pi-long-horizon/liminal-context/packages/lhc/docs/02-specs/02-derivation-pipeline/artifacts/00-foundation/story-lead/001-ruling-response-002.json"
replayBoundary: null
updatedAt: "2026-06-11T03:30:12.283Z"
```
...
-
  storyRunId: "00-foundation-story-run-001"
  sequence: 18
  timestamp: "2026-06-11T03:29:35.070Z"
  type: "story-lead-provider-started"
  summary: "Fresh story-lead provider turn executed without planner session resume."
  data:
    provider: "codex"
    model: "gpt-5.5"
    reasoningEffort: "high"
    promptArtifactPath: "/Users/leemoore/code/pi-long-horizon/liminal-context/packages/lhc/docs/02-specs/02-derivation-pipeline/artifacts/00-foundation/story-lead/prompts/001-planner-turn-005.md"
    sessionId: "019eb4ba-3144-7bb1-a86a-c6ec06de48da"
-
  storyRunId: "00-foundation-story-run-001"
  sequence: 19
  timestamp: "2026-06-11T03:29:35.090Z"
  type: "story-lead-action-selected"
...
-
  storyRunId: "00-foundation-story-run-001"
  sequence: 20
  timestamp: "2026-06-11T03:29:35.118Z"
  type: "needs-ruling"
  summary: "Story-lead finalized 00-foundation-story-run-001 with outcome needs-ruling."
  artifact: "/Users/leemoore/code/pi-long-horizon/liminal-context/packages/lhc/docs/02-specs/02-derivation-pipeline/artifacts/00-foundation/story-lead/001-final-package.json"
  data:
...
-
  storyRunId: "00-foundation-story-run-001"
  sequence: 21
  timestamp: "2026-06-11T03:30:12.258Z"
  type: "story-run-resumed"
  summary: "Story orchestration resume started."
-
  storyRunId: "00-foundation-story-run-001"
  sequence: 22
  timestamp: "2026-06-11T03:30:12.282Z"
  type: "ruling-received"
  summary: "Caller ruling received for 00-foundation-story-run-001-ruling-spec-deviation."
  artifact: "/Users/leemoore/code/pi-long-horizon/liminal-context/packages/lhc/docs/02-specs/02-derivation-pipeline/artifacts/00-foundation/story-lead/001-ruling-response-002.json"
  data:
    rulingRequestId: "00-foundation-story-run-001-ruling-spec-deviation"
    decision: "approve"
    source: "impl-lead"
