...
nextIntent:
  ...
  summary: "Caller ruling approves the two deviations that made SV-03-001 blocking, but the latest verifier outcome is still needs-human-ruling. Re-run verifier on the existing result plus ruling artifact so the finding can be closed before any acceptance recommendation."
  artifactRef: "/Users/leemoore/code/pi-long-horizon/liminal-context/packages/lhc/docs/02-specs/04-inspection/artifacts/03-view-contents-report/006-verify.json"
replayBoundary: null
updatedAt: "2026-06-12T15:04:42.595Z"
```
